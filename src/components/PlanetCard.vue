...
<template>
  <div class="rounded-md max-w-full bg-neutral-950 text-neutral-50 p-8 shadow ring ring-transparent hover:ring-yellow-600">
    ...
    <div class="divide-y divide-neutral-950">
      ...
      <div class="pt-4">
        <ul class="grid grid-cols-2 md:flex items-center gap-4 text-neutral-200 lg:gap-8">
          <li class="flex gap-2">
            <svg
